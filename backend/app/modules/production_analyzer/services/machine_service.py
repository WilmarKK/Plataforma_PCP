...
from app.modules.production_analyzer.models.machine import Machine
from app.modules.production_analyzer.schemas.machine import MachineCreate, MachineUpdate
