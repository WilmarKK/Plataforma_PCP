"""
Regras de produção para a máquina CV Guangya.
...
def extract_setup_time(row: Dict[str, Any]) -> int:
    """
    Extrai o tempo de setup para a máquina CV Guangya com base no campo 'Processo'.
...
def extract_production_speed(row: Dict[str, Any]) -> int:
    """
    Retorna a velocidade padrão de produção da CV Guangya.
    :param row: Dicionário com os dados do registro.
